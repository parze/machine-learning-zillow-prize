...
% TODO: Define the actual metric to use when models are learning
...
% todo:
% list pros and cons for LightGBM
% list pros and cons for Xgboost
% describe why a constant model can improve the result
% describe why it is good to weight the result
...
% TODO: get name for performance metric
\begin{enumerate}
