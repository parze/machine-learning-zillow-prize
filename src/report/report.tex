...
As a benchmark, the result will be compared with the \textit{Baseline} which is an extremely simple model to
understand. Good candidates can then be omitted to the public leader board of Kaggle to be compared towards
other team models.
...
\begin{enumerate}
    \item neither train result nor test result improved indicates that the change made the model worse
        and the change was reverted
    \item train result improved but the test result did not indicates that the change made the model overfit
        and the change was reverted
